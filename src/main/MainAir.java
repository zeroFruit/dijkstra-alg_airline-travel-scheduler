...
//		}
		...
		System.out.println(
				"Elapsed times: " + planning + " (millsec) for planning, " + scheduling + " (millisec) for scheduling");
		...
		if (TMB.isThreadCpuTimeSupported()) {
			...
			System.out.println("Total CPU time consumed by the thread: " + (cputime / 1000000) + " (millsec)");
		}
	}
}
